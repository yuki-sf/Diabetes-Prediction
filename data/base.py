...
footer = """
    ...
    .footer {
        ...
        bottom: 0;
        width: 100%;
        background-color: rgba(0, 0, 255, 1);  /* Very transparent blue */
        text-align: center;
        padding: 10px;
        font-size: 14px;
    ...
    <div class="footer">
        <p>Diabetes Prediction | Data Source: National Institute of Diabetes and Digestive and Kidney Diseases | © 2025 Yuki-sf <a href="https://github.com/yuki-sf" target="_blank">GitHub</a></p>
    </div>
    """
